...
import hireUsbg from "../assets/hireuspage.jpg";
...
const HireUs = () => {
  return (
    <section>
      ...
      <div
        className="w-full min-h-[560px] flex items-center justify-center relative"
        style={{
          backgroundImage: `url(${hireUsbg})`,
      ...
      >
        ...
        <div
          className="relative z-10 text-white text-[50px] font-bold text-center"
          data-aos="flip-left"
          data-aos-offset="200"
          data-aos-easing="ease-in-sine"
        >
          Hourly Based <br /> Pricing Model
        </div>
      </div>

      {/* Section Title */}
      <div className="relative z-10 text-black text-[40px] font-bold text-center mt-5">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <motion.div
            ...
            className="min-h-[400px] w-full max-w-md md:max-w-full"
            style={{
...
>
  ...
  >
 <i className="fa-solid fa-circle text-black-500 mr-3"></i> Sliders of technology will be displayed on site.
  </motion.li>
  ...
  <motion.li
    ...
    className="flex items-start mt-2"
  >
    <i className="fa-solid fa-circle text-black-500 mr-3"></i> Quality assurance and security scans.
  </motion.li>
  ...
  <motion.li
    ...
    className="flex items-start mt-2"
  >
    <i className="fa-solid fa-circle text-black-500 mr-3"></i> Development of customized solutions and meeting designed standards.
  </motion.li>
  ...
  <motion.li
    ...
    className="flex items-start mt-2"
  >
   <i className="fa-solid fa-circle text-black-500 mr-3"></i> Quick, reliable, and qualified resources at your service.
  </motion.li>
  ...
  <motion.li
    ...
    className="flex items-start mt-2"
  >
 <i className="fa-solid fa-circle text-black-500 mr-3"></i> Bug fixing and omitting minor programming language errors.
  </motion.li>
  ...
  <motion.li
    ...
    className="flex items-start mt-2"
  >
    <i className="fa-solid fa-circle text-black-500 mr-3"></i> Select the best skilled team.
  </motion.li>
  ...
  <motion.li
    ...
    className="flex items-start mt-2"
  >
   <i className="fa-solid fa-circle text-black-500 mr-3"></i> Cost-effective solutions.
  </motion.li>
  ...
  <motion.li
    ...
    className="flex items-start mt-2"
  >
    <i className="fa-solid fa-circle text-black-500 mr-3"></i> Real-time response.
  </motion.li>
  ...
  <motion.li
    ...
    className="flex items-start mt-2"
  >
    <i className="fa-solid fa-circle text-black-500 mr-3"></i> Maximizes your ROI.
  </motion.li>
</motion.ul>
