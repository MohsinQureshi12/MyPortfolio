...
import hireUsbg from "../../public/assets/image/hireuspage.jpg";
  ...
  return (
    <section>
      ...
      >
        ...
        {/* Text */}
        <div
          className="relative z-10 text-white text-center font-bold text-3xl sm:text-4xl md:text-5xl lg:text-[50px] leading-snug px-4"
          data-aos="flip-left"
          data-aos-offset="200"
      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <motion.div
            ...
            className="w-full h-[250px] sm:h-[300px] md:h-[400px] lg:h-[500px] xl:h-[600px] max-w-[90%] sm:max-w-md md:max-w-full rounded-xl"
            style={{
