...
const ServicePortfolio = () => {
    return (
        <section className="w-full lg:py-20 py-8 px-4 md:px-8 lg:px-16 bg-white relative">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <h2 className="lg:text-3xl text-lg font-extrabold text-black leading-[1.1] mb-4">
                       Capabilities. One Global Standard of Excellence.
                    </h2>
                    <p className="text-grey-light font-medium text-sm md:text-base max-w-3xl">
                        From AI and software development to cloud, data, and digital transformation, our capabilities cover the technology businesses need to innovate, scale, and stay competitive.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {portfolioItems?.map((item) => (
                        <div
                            key={item.id}
                            className="relative rounded-[20px] overflow-hidden h-[390px] group cursor-pointer shadow-lg"
                        >
                            {/* Background Image */}
                            <div
                                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105 w-full"
                            ...
                            <div className="absolute top-6 left-6 w-8 h-8 rounded-full border border-white/30 flex items-center justify-center bg-white/10 backdrop-blur-sm z-10 transition-all duration-500 group-hover:scale-110 group-hover:bg-primary group-hover:border-primary">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-8 z-10 flex flex-col justify-end">
                                <h3 className="text-white lg:text-2xl text-lg font-bold tracking-tight mb-2 transition-transform duration-500 group-hover:-translate-y-2">
                                    {item.title}
                                </h3>
