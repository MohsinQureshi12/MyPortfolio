...
//           <div className="mt-3 h-[2px] bg-white w-[150px]"></div>{" "}
//           {/* Underline */}
...
//             <h3 className="text-xl font-semibold mb-1 text-[#0E315A]">
//               Custom Development
//             </h3>
...
//             </h3>
//             <p className="text-gray-700">
//               We design solutions like smart contracts, DEXs, DeFi, NFTs,
//               gamification, etc., based on blockchain technology.
//             </p>
//             <div className="border border-black rounded-full p-1 inline-flex items-center justify-center mt-[10px] ml-[210px]">
//               <i className="fa-solid fa-arrow-right"></i>
//             </div>
...
//               src={ServiceCart3}
//               alt=""
//               className="h-[80px] mb-[10px] w-[100px]"
//             />
//             <h3 className="text-xl font-semibold mb-1 text-[#0E315A]">
//               Game Development
//             </h3>
//             <p className="text-gray-700">
//               We develop pixel-perfect games with future-proof architecture and
//               high resolution, using the latest technologies.
//             </p>
//             <div className="border border-black rounded-full p-1 inline-flex items-center justify-center mt-[10px] ml-[210px]">
//               <i className="fa-solid fa-arrow-right"></i>
//             </div>
...
//             </h3>
//             <p className="text-gray-700">
//               We provide dedicated resources and staff augmentation to
//               enterprises worldwide for IT support and success.
//             </p>
//             <div className="border border-black rounded-full p-1 inline-flex items-center justify-center mt-[10px] ml-[210px]">
//               <i className="fa-solid fa-arrow-right"></i>
//             </div>
...
//             </h3>
//             <p className="text-gray-700">
//               We solve modern business challenges with a cloud-native approach
//               towards enterprise-grade apps and services.
//             </p>
//             <div className="border border-black rounded-full p-1 inline-flex items-center justify-center mt-[10px] ml-[210px]">
//               <i className="fa-solid fa-arrow-right"></i>
//             </div>
...
//             </h3>
//             <p className="text-gray-700">
//               We craft, manage and publish interactive and engaging content to
//               grow brands using data-driven strategies.
//             </p>
//             <div className="border border-black rounded-full p-1 inline-flex items-center justify-center mt-[10px] ml-[210px]">
//               <i className="fa-solid fa-arrow-right"></i>
//             </div>
...
//               src={ServiceCart8}
//               alt=""
//               className="h-[80px] mb-[10px] text-[#0E315A]"
//             />
//             <h3 className="text-xl font-semibold mb-1 text-[#0E315A]">
