        ...
        <section>
            ...
            <div className='w-full flex flex-col items-center bg-black py-8 relative'>
                ...
                <div className="flex justify-center">
                    <img className='w-[192px] h-[100px] mb-10' src={logo} alt="Street Coders Logo" />
                </div>

                {/* Main Content */}
                <div className='container flex flex-col md:flex-row justify-center h-full'>
                    ...
                    <div className='w-1/3 flex-col'>
                        ...
                        <div className="mt-2 h-[2px] bg-white w-[200px]"></div> {/* Underline */}

                        <ul className="list-inside text-white mt-4">
                            <li>Why Street Coders?</li>
                            <li>Careers</li>
                            <li>Hire Us</li>
                            <li>Products</li>
                            <li>Blog</li>
                    ...
                    <div className='w-1/3 flex-col text-center md:text-left'>
                        <h1 className="text-white font-bold mb-2">
                            Services
                        </h1>
                        <div className="mt-2 h-[2px] bg-white w-[200px]"></div> {/* Underline */}
                    ...
                    <div className='w-1/3 flex flex-col text-center md:text-left'>
                        <h2 className="text-white font-bold mb-2">Hire Dedicated Resourcse</h2>
                        <div className="h-[2px] bg-white w-[200px]"></div> {/* Underline */}
                        ...
                        <ul className="list-inside text-white mt-4">
                            ...
                            <li>Web & Graphics Designer</li>
                            <li>Technical Resource Outsourcing</li>
                        </ul>
                    ...
                    <div className='w-1/3 flex flex-col text-center md:text-left'>
                        ...
                        <div className="h-[2px] bg-white w-[200px]"></div> {/* Underline */}
                        <ul className="list-inside mt-4 text-white">
                            <li>info@Scsolutions.com</li>
                            <li>+92.3074453612</li>
                            <li>Office # PCSIR lahore</li>
                            <li>Punjab Society, Lahore Pakistan</li>
                            <li>Sharjah Media City</li>
                            <li>Copyright 2025 Street Coders</li>
                        </ul>

                        {/* Contact Us Button */}
                        <div className="mt-6">
                            <a href="/contact" className="text-white py-2 px-4 rounded border border-white hover:bg-white hover:text-black transition">
                                Contact Us
                            </a>
                ...
                <div className="mt-10 h-[2px] bg-white w-[1348px]"></div> {/* Underline */}
